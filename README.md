...
- **SAP MDK** (Mobile & Offline Apps) | **SAP Build Apps** (Low-Code/No-Code)  
- **SAP BTP** | **OData Services** 
- **JavaScript | TypeScript | REST APIs**  
- **Mobile UI/UX Optimization & Custom Extensions**  

## 📌 What I Do  
✔ Develop and extend **SAP MDK** mobile applications with **offline capabilities**  
✔ Build **low-code/no-code** solutions using **SAP Build Apps**  
✔ Integrate **SAP BTP & Fiori elements** for seamless mobile experiences  
